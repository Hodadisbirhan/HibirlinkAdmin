    ...
    >
      <div>
        ...
        >
          ...
          />
          <span class="ml-1 hidden sm:block font-bold">Previous</span>
        </a>
      </div>
      ...
      <div>
        <a
          ...
          "
        >
          <span class="mr-1 hidden sm:block font-bold">Next</span>
          <Icon
    ...
    <div v-else class="flex w-full flex-wrap justify-between mx-10">
      <div>
        ...
        >
          ...
          />
          <!-- <ChevronLeftIcon class="h-5 w-6 text-primary" aria-hidden="true" /> -->
      ...
      <div>
        ...
        >
          ...
          <Icon
            ...
            aria-hidden="true"
          />
          <!-- <ChevronRightIcon class="h-5 w-6 text-primary" aria-hidden="true" /> -->
        </a>
      </div>
    </div>
  </div>
