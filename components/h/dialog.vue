  ...
  >
    ...
    >
      <div
        ref="target"
        :class="[parentClass]"
        class="relative flex flex-col max-w-6xl m-5 w-full gap-2 p-6 rounded-md shadow-custom bg-light400 text-neutral-500"
      >
        <Icon
...
props.setValue && setValues(props.setValue);

watch(
  () => props.setValue,
  (newValue) => {
    newValue && setValues(newValue);
  }
);
</script>
