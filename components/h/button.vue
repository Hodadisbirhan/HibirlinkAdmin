      ...
      :class="[
        ...
        props.rounded
          ? props.roundedClass
            ...
            : 'rounded-full'
          : '',
        btnHeight ? btnHeight : 'h-8',
      ]"
      class="w-full box-border hover:shadow-md shadow-current font-semibold focus:outline-none focus:shadow-outline transition-all duration-200 ease-in-out"
    >
      <div
      ...
      >
        ...
        <div
          v-if="!props.isLoading && props.leadingIcon"
