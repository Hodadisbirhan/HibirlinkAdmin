    ...
    >
      ...
      >
        ...
        <div class="flex flex-wrap gap-8">
          ...
          <p class="font-semibold">
            <span class="text-blue-500">Working Hour</span> :
            {{ selectedService.availability.per_day.start_time }}-
            {{ selectedService.availability.per_day.end_time }}
          </p>
          <div class="font-semibold flex gap-2">
            <span class="text-blue-500">Working Day</span> :
            <p
              v-for="day in selectedService.availability.per_week"
              :key="day"
              class="flex gap-1"
            >
...
import fetchServices from "@/apollo/query/services/realtime/fetchService.gql";
import fetchCategory from "@/apollo/query/services/realtime/fetchCategory.gql";
import updateServiceStatus from "@/apollo/mutation/service/physical/updateServiceStatus.gql";
import rejectService from "@/apollo/mutation/service/physical/rejectService.gql";
