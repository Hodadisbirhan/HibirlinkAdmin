<template>
  <div class="relative">
    ...
    >
      <div
        class="p-4 pb-0 relative border bg-light150/20 hover:border-primary rounded-md shadow-sm"
...
import updateMainCategoryGql from "@/apollo/mutation/service/virtual/updateMainCategory.gql";
import deleteCategoryGql from "@/apollo/mutation/product/physical/deleteCategory.gql";
import addCategoryGql from "@/apollo/mutation/service/virtual/addCategory.gql";
definePageMeta({
  layout: "custom",
});
